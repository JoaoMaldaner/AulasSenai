...
botao_pedra = tk.Button(frame_baixo, command=lambda: jogar("Pedra"), image=imagem_pedra, width=50, height=50, bg=cor0, relief="flat", overrelief="solid")
botao_pedra.place(x=20, y=20)

imagem_papel = tk.PhotoImage(file="papel.png").subsample(8, 6)
botao_papel = tk.Button(frame_baixo, command=lambda: jogar("Papel"), image=imagem_papel, width=50, height=50, bg=cor0, relief="flat", overrelief="solid")
botao_papel.place(x=100, y=20)

imagem_tesoura = tk.PhotoImage(file="tesoura.png").subsample(8, 6)
botao_tesoura = tk.Button(frame_baixo, command=lambda: jogar("Tesoura"), image=imagem_tesoura, width=50, height=50, bg=cor0, relief="flat", overrelief="solid")
